    ...
    return (
      <div className="max-w-3xl mx-auto px-4 bg-white p-8 rounded-xl shadow-sm border border-slate-200 w-full">
        ...
        <div className="text-center">
          <a href={`https://wa.me/5561992809250?text=${text}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-lg font-bold text-lg transition-colors shadow-md w-full sm:w-auto">
