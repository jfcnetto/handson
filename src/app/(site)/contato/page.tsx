        ...
        <div className="prose prose-lg text-slate-700 max-w-none mb-12">
          ...
          <ul className="list-none pl-0">
            <li className="flex items-center gap-2 mb-2">
              <a href="https://wa.me/5561994005941" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700 font-bold flex items-center gap-1">
